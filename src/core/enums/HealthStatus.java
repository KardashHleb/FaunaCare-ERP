 ...
 * Используется для отслеживания состояния здоровья животных
 * и планирования соответствующих медицинских процедур.
 * Следует принципу открытости/закрытости (OCP) -
 * легко добавить новый статус без изменения существующего кода.
 */
